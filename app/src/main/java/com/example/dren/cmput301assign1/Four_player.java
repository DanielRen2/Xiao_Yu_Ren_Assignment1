...
public class Four_player extends ActionBarActivity {
    ...
    public void button3_1(View v){
        MultiGameController.saveReaction(this, "Player 1" , "statsMulti4");
        popUp(v, "Player 1");

    }
    public void button3_2(View v){
        MultiGameController.saveReaction(this, "Player 2", "statsMulti4");
        popUp(v, "Player 2");
    }
    public void button3_3(View v){
        MultiGameController.saveReaction(this, "Player 3" , "statsMulti4");
        popUp(v, "Player 3");
    }
    public void button3_4(View v){
        MultiGameController.saveReaction(this, "Player 4" , "statsMulti4");
        popUp(v, "Player 4");
    }
